...
INSERT INTO MEMBER VALUES(
    SEQ_UNO.NEXTVAL,'user10', 'user10','유저','010-0000-0000','a3n@3.com',1,'서울시 강남구 역삼동', NULL,NULL, SYSDATE, SYSDATE, DEFAULT);
...
(SEQ_BOARD_NO.NEXTVAL, 21, '서울', '포토존','포토존 게시글입니다.','내용입니다', DEFAULT, 
'원본파일명.txt', '변경된파일명.txt','도보','0',0,SYSDATE,SYSDATE, 'Y');
...
WHERE B.BOARD_WRITER_NO = M.USER_NO AND B.STATUS ='Y' AND B.LOC_NAME='강원도' AND B.BOARD_NAME='여행'
...
FROM BOARD B, MEMBER M
WHERE B.BOARD_WRITER_NO = M.USER_NO AND B.STATUS ='Y' AND B.BOARD_NO=16
ORDER BY BOARD_NO DESC;

SELECT BOARD_TITLE, BOARD_CONTENT
FROM BOARD 
WHERE BOARD_WRITER_NO = 20;

SELECT BOARD_TITLE, BOARD_CONTENT
FROM BOARD B, LIKECOUNT L
WHERE B.BOARD_NO = L.BOARD_NO AND L.STATUS = 'Y' AND USER_NO = 21;
...
INSERT INTO LIKECOUNT VALUES(163,21,'Y');
