...
<div class="uploadPageArea">
	...
	<div>
		...
		<p align="center" id="questions"><span>당신의 평가는?</span>	&nbsp;&nbsp;&nbsp; <span id="grade" style="font-size: 18pt;">0</span><span style="font-size: 18pt;"> / 5</span></p>
	 	<p align="center">
		<select name="starGrade" style="color: yellow; font-size: 28pt; padding-bottom: 15px;" id="star_grade">
			<option value="0" style="color: yellow; font-size: 30pt"></option>
			<option value="1" style="color: yellow; font-size: 25pt">★</option>
			<option value="2" style="color: yellow; font-size: 25pt">★★</option>
			<option value="3" style="color: yellow; font-size: 25pt">★★★</option>
			<option value="4" style="color: yellow; font-size: 25pt">★★★★</option>
			<option value="5" style="color: yellow; font-size: 25pt">★★★★★</option>		
		</select>
		</p> 
