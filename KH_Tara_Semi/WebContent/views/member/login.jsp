...
<body>
			...
			<form action="<%=request.getContextPath() %>/login" id="loginfrm" method="POST">
			 <input name="userId" id="userId" type="text" placeholder="아이디를 입력해주세요." size="30" value="<%= saveId == null ? "" : saveId %>" required>  <br>
			 <input name="userPwd" id="userPwd" type="password" placeholder="패스워드를 입력해주세요." size="30" required>  <br>
