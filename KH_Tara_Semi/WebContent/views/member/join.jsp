...
<section>
   ...
   <div class="join-container">
       ...
       <form action="<%=request.getContextPath()%>/member/join" method="POST" name="memberJoinfrm" >
         <table >
          ...
          <tr>
             <th>회원구분</th>
			 <td>
				<input id="member_type" type="radio" checked="checked"/><label  style="font-weight: lighter; font-size: 10pt;"> 일반 회원</label> 
			 </td>            
          </tr> 
          <tr></tr>         
          <tr></tr>         
        ...
        <tr>        
            <th >비밀번호 확인 </th>
            <td>
            	<input id="pass2"  maxlength="10"  value="" type="password"  required/>
            </td>
        </tr>
        <tr></tr>         
        <tr></tr> 
        ...
        <tr></tr>          
        <tr> 
           <th>이름 <img src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif" class="" alt="필수"/> </th>
             <td>
       ...
       <tr>
           	<th> 
           		여행 가고 싶은 곳  <img src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif" class="" alt="필수"/> 
         	 		<br> (여행 갈 곳)&nbsp;&nbsp; 
 	 	    </th>
           	<td>
       ...
       <tr>  
             ...
             <td>
				...
				</select> - <input id="mobile2" name="mobile2" maxlength="4" size="2"  type="text"/> - <input id="mobile3" name="mobile3" maxlength="4" size="2"  value="" type="text"/>
			</td>
      </tr>
      <tr></tr>         
      <tr></tr> 
...
/*$("#email1").on("focus",() => {
		...
		if( !mobile2Reg.test( $("#mobile2").val() ) || !mobile3Reg.test( $("#mobile3").val() ))  {
