...
public class Board {
	...
	public Board(int boardNo, int rowNum, int boardWriteNo, String userId, String locName, String boardName,
			String boardTitle, String boardContent, int boardReadCount, String boardOriginalFileName,
	...
	public String toString() {
		return "Board [boardNo=" + boardNo + ", rowNum=" + rowNum + ", boardWriteNo=" + boardWriteNo + ", userId="
				+ userId + ", locName=" + locName + ", boardName=" + boardName + ", boardTitle=" + boardTitle
				+ ", boardContent=" + boardContent + ", boardReadCount=" + boardReadCount + ", boardOriginalFileName="
				+ boardOriginalFileName + ", boardRenamedFileName=" + boardRenamedFileName + ", transport=" + transport
				+ ", travelMoney=" + travelMoney + ", boardScore=" + boardScore + ", boardCreateDate=" + boardCreateDate
